export const env = {
    API: import.meta.env.VITE_API_URL || "http://auth.main.local:5500/api/v1",
    ...
    API_AUTH: import.meta.env.VITE_API_AUTH_URL || "http://auth.main.local:55000/api/v1",
    API_AUTH_PORTAL: import.meta.env.VITE_API_AUTH_URL || "http://auth.main.local:5174",
    SOCKET_URL: import.meta.env.VITE_SOCKET_URL || "http://auth.main.local:5500",
