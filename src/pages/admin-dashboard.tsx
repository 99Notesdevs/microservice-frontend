  ...
  <div className="p-8 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <h3 className="font-medium text-gray-800 mb-1">Add Questions</h3>
        <p className="text-sm text-gray-500">Create new questions for tests</p>
      </Link>
      ...
      >
        ...
        <h3 className="font-medium text-gray-800 mb-1">Manage Test Series</h3>
        <p className="text-sm text-gray-500">View and organize test series</p>
      </Link>

      <Link 
        to="/admin/addtestseries" 
        className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex flex-col items-center text-center"
      >
        <div className="bg-purple-100 p-3 rounded-full mb-4">
          <FiPlus className="h-6 w-6 text-purple-600" />
        </div>
        <h3 className="font-medium text-gray-800 mb-1">Create Test Series</h3>
        <p className="text-sm text-gray-500">Set up a new test series</p>
      </Link>
    </div>
  </div>
);
